const CACHE_NAME = "orbital-cleanup-v0.11-contracts10";
const APP_SHELL = [
  "./",
  "./index.html",
  "./update.html",
  "./styles.css",
  "./styles.css?v=0.11-contracts10",
  "./src/contracts.js",
  "./src/contracts.js?v=0.11-contracts10",
  "./src/game.js",
  "./src/game.js?v=0.11-contracts10",
  "./src/input.js",
  "./src/input.js?v=0.11-contracts10",
  "./src/art.js",
  "./src/art.js?v=0.11-contracts10",
  "./src/art/sprites.png",
  "./src/art/contracts.png",
  "./src/art/earth.png",
  "./src/levels.js",
  "./src/levels.js?v=0.11-contracts10",
