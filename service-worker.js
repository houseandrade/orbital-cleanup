const CACHE_NAME = "orbital-cleanup-v0.13-finale3";
const APP_SHELL = [
  "./",
  "./index.html",
  "./update.html",
  "./styles.css",
  "./styles.css?v=0.13-finale3",
  "./src/contracts.js",
  "./src/contracts.js?v=0.13-finale3",
  "./src/game.js",
  "./src/game.js?v=0.13-finale3",
  "./src/input.js",
  "./src/input.js?v=0.13-finale3",
  "./src/art.js",
  "./src/art.js?v=0.13-finale3",
  "./src/art/sprites.png",
