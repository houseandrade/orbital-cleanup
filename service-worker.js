const CACHE_NAME = "orbital-cleanup-v0.9-levels1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./update.html",
  "./styles.css",
  "./styles.css?v=0.9-levels1",
  "./src/game.js",
  "./src/game.js?v=0.9-levels1",
  "./src/input.js",
  "./src/input.js?v=0.9-levels1",
  "./src/art.js",
  "./src/art.js?v=0.9-levels1",
  "./src/art/sprites.png",
  "./src/art/earth.png",
  "./src/levels.js",
  "./src/levels.js?v=0.9-levels1",
