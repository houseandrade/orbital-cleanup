const CACHE_NAME = "orbital-cleanup-v0.21.3";
const APP_SHELL = [
  "./",
  "./index.html",
  "./update.html",
  ...
  "./styles.css?v=0.21.3",
  "./src/contracts.js",
  "./src/contracts.js?v=0.21.3",
  "./src/game.js",
  "./src/game.js?v=0.21.3",
  "./src/input.js",
  "./src/input.js?v=0.21.3",
  "./src/art.js",
  "./src/art.js?v=0.21.3",
  "./src/art/sprites.png",
  ...
  "./src/art/earth.png",
  "./src/art/mars/ascent-engine.png",
  "./src/art/mars/habitat-support-frame.png",
  "./src/art/mars/mars-background.png",
  "./src/art/mars/sample-canister.png",
  "./src/art/mars/solar-array-section.png",
  "./src/art/mars/survey-drone.png",
